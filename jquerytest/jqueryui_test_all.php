...
<head>
  ...
  <link href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.10.2/themes/<?php echo $theme; ?>/jquery-ui.css" rel="stylesheet" />
...
<body>
jQuery UI 測試 : 切換主題布景 : 
<form method=post action="jqueryui_test_all.php">
